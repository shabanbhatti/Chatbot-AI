                          ...
                          BlocBuilder<ChatRoomBloc, ChatRoomState>(
                            ...
                            builder: (context, state) {
                              if (state is LoadingChatRoom) {
                                ...
                                var list = state.chatRoomEntities.reversed
                                    .toList();
                                    ...
                                    return (list[index].title.isEmpty)
                                        ...
                                        : CupertinoListTile(
                                            onTap: () async {
                                              ...
                                              context
                                                  .read<ChatRoomIdPrefBloc>()
                                                  .add(
                                                    SetChatRoomIdPrefEvent(
                                                      value: data.id,
                                                    ),
                                                  );
                                              context
                                                  .read<NewChatPrefBloc>()
                                                  .add(
                                                    SetNewChatboolPrefEvent(
                                                      value: false,
                                                    ),
                                                  );
...
Widget _topWidget(
  ...
  return Padding(
    padding: const EdgeInsetsGeometry.only(left: 15, top: 20),
    child: Hero(
      tag: 'move_to',
      child: Row(
        children: [
